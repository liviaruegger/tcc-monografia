...
\subsection{Sobre o uso de ferramentas de IA assistida no desenvolvimento}
\label{subsec:ia-desenvolvimento}

A prova de conceito foi desenvolvida utilizando o Cursor, um editor de código com inteligência artificial integrada baseada em modelos de linguagem (LLM), seguindo práticas comuns na indústria de software atual. A ferramenta foi utilizada como acelerador do processo de desenvolvimento, com os cuidados necessários para garantir que os agentes de IA atuassem como assistentes no processo de codificação, e não como geradores de soluções completas sem supervisão adequada. Quando houve uso direto de IA para geração de código, isso foi explicitamente documentado nas mensagens de commit do repositório, especificando a ferramenta utilizada e o tipo de uso realizado, garantindo transparência no processo de desenvolvimento.
