...
Este apêndice apresenta o código do script prototípico desenvolvido para o \emph{QGIS Processing Toolbox}, que serviu como validação inicial da lógica de conversão antes do desenvolvimento do \emph{plugin} completo. O script demonstra os algoritmos fundamentais de processamento.

O script foi implementado como uma ferramenta do \emph{Processing Framework} do QGIS, permitindo execução direta através da interface de processamento. Embora funcional, esta solução apresenta limitações em termos de interface de usuário e distribuição quando comparada ao \emph{plugin} completo desenvolvido posteriormente.
