...
Este apêndice apresenta o código do script prototípico desenvolvido para o \emph{QGIS Processing Toolbox}, que serviu como validação inicial da lógica de conversão antes do desenvolvimento do \emph{plugin} completo. O script demonstra os algoritmos fundamentais de processamento, incluindo normalização de valores, tratamento de padding e cálculo de dimensões.
