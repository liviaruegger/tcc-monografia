...
\begin{tabular}{rl}
  ...
  OGR     & \emph{OpenGIS Simple Features Reference Implementation}           \\
  OSGeo   & \emph{Open Source Geospatial Foundation}                          \\
  PyQGIS  & \emph{Python API para QGIS}                                       \\
  ...
  UTM     & \emph{Universal Transverse Mercator}                              \\
