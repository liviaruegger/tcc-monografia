...
\title{Contribuindo com o QGIS}[Experiências no desenvolvimento de software livre para Sistemas de Informação Geográfica]
\translatedtitle{Contributing to QGIS}[Experiences in developing free software for Geographic Information Systems]

\author[fem]{Ana Lívia Rüegger Saldanha}

\def\profa{Prof\kern.02em.\kern-.07emª\kern.07em}
\def\dra{Dr\kern-.04em.\kern-.11emª\kern.07em}

% Para TCCs, este comando define o orientador
\orientador[fem]{Juliana Orro Marquez}

% Se não houver, remova; se houver mais de um, basta
% repetir o comando quantas vezes forem necessárias
\coorientador{Prof. Dr. Paulo Meirelles}

% Não há banca para este TCC
%\banca{
%  \profa{} \dra{} Juliana Orro Marquez (orientadora) -- UNIFESP [sem ponto final],
%  % Em inglês, não há o "ª"
%  %Prof. Dr. Juliana Orro Marquez (advisor) -- UNIFESP [sem ponto final],
%  Prof. Dr. Paulo Meirelles (coorientador) -- IME-USP [sem ponto final],
%  % Adicionar membros da banca aqui quando definidos
%}
...
\defesa{
  local={São Paulo},
  data=2025-09-01, % YYYY-MM-DD (para TCC, apenas o ano será exibido)
}
...
% Se houver apoio financeiro, descomente e preencha acima
...
\begin{tabular}{rl}
  ...
  BIL     & \emph{Band Interleaved by Line}                                           \\
  CLI     & \emph{Command Line Interface}                                             \\
  CRS     & \emph{Coordinate Reference System} (Sistema de Coordenadas de Referência) \\
  FAUUSP  & Faculdade de Arquitetura e Urbanismo da Universidade de São Paulo         \\
  GDAL    & \emph{Geospatial Data Abstraction Library}                                \\
  GIS     & \emph{Geographic Information System} (Sistema de Informação Geográfica)   \\
  GPL     & \emph{GNU General Public License}                                         \\
  IME     & Instituto de Matemática e Estatística                                     \\
  MAC0500 & Trabalho de Formatura Supervisionado Voltado à Extensão                   \\
  MDE     & Modelo Digital de Elevação                                                \\
  OGR     & Biblioteca para Dados Vetoriais (parte da GDAL)                           \\
  OSGeo   & \emph{Open Source Geospatial Foundation}                                  \\
  PyQGIS  & Interface de Programação Python para QGIS                                 \\
  QGIS    & \emph{Quantum Geographic Information System}                              \\
  RGB     & \emph{Red, Green, Blue}                                                   \\
  RF      & Requisito Funcional                                                       \\
  SIG     & Sistema de Informação Geográfica                                          \\
  TCC     & Trabalho de Conclusão de Curso                                            \\
  TIFF    & \emph{Tagged Image File Format}                                           \\
  USP     & Universidade de São Paulo                                                 \\
  VR      & \emph{Virtual Reality}                                                    \\
\end{tabular}

% Lista de símbolos removida
...
\pagestyle{mainmatter}
\input{conteudo/01-referencial-teorico}
\input{conteudo/02-estudo-de-caso}
\input{conteudo/03-consideracoes-finais}
...
% Apêndices e anexos removidos por enquanto
% \appendix
% \addappheadtotoc
...
%\printindex % imprime o índice remissivo no documento (opcional) - removido
